      ...
      <div className="container body-content">
        {
          isAuthenticated() && (
		    <div>
              <h3>Logs</h3>
			  <span>Logs are stored under <a href="https://us-west-2.console.aws.amazon.com/cloudwatch/home?region=us-west-2#" target="_blank">CloudWatch</a> for the account the application is
